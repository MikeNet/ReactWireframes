...
const App: React.FC = () => {
  const [selectedLayout, setSelectedLayout] = useState<LayoutId>("sidebar-content");
      ...
      <section style={contentStyle}>
        ...
        <div style={contentBodyStyle}>
          <div style={cardStyle}>
            ...
            <p>
              This is where your main page content lives. Think dashboards, tables, or
              detail views.
            </p>
          </div>
        </div>
...
const masterItems: Item[] = [
  ...
  },
  {
    ...
    details: "Flagged as at-risk. Surface reasons and recommended interventions.",
  },
];
        ...
        <div>
          {masterItems.map((item) => (
            ...
            >
              ...
              <div style={{ fontSize: 12, color: "#6B7280" }}>{item.summary}</div>
            </div>
          ))}
        </div>
      </section>
...
const WizardExample: React.FC = () => {
  ...
  const goBack = () => canGoBack && setStep((prev) => (prev - 1) as WizardStepId);
  const goNext = () => canGoNext && setStep((prev) => (prev + 1) as WizardStepId);
      ...
      <section style={{ padding: 16 }}>
        ...
        <div style={{ ...cardStyle, marginTop: 16 }}>
          ...
          <div style={wizardButtonRowStyle}>
            <button onClick={goBack} disabled={!canGoBack} style={secondaryButtonStyle}>
              Back
            </button>
            {step < 3 ? (
  ...
  return (
    <div style={shellVerticalStyle}>
      <header style={contentHeaderStyle}>
        ...
        <div>Use this pattern for back-office data, admin tools, and analytics.</div>
      </header>
